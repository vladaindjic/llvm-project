...
#pragma omp parallel num_threads(1)
  ...
  // Consider the callstacks of the master thread while executing the foo
  ...
  // 2) clang is used to generate the code.
        ...
        // #4  0x00007ffff7abd746 in __kmp_fork_call
        // #5  0x00007ffff7aa7930 in __kmpc_fork_call
        // #6  0x0000000000403231 in main ()
