...
This function should not be called from within the runtime code.
The calls to this function should be only generated by the clang compiler.
*/
void __kmpc_end_serialized_parallel(ident_t *loc, kmp_int32 global_tid) {
  // The parallel region's wrapper function is called by the
  // OpenMP (user) program directly.
  __kmp_end_serialized_parallel(loc, global_tid, ompt_parallel_invoker_program);
}
